      ...
      <div>
        ...
        >
          <div className="hamburger-line hamburger-line-1">
            <div className="hamburgercolr hamburger-line-in hamburger-line-in-1"/>
          </div>
          <div className="hamburger-line hamburger-line-2">
            <div className="hamburgercolr hamburger-line-in hamburger-line-in-2"/>
          </div>
          <div className="hamburger-line hamburger-line-3">
            <div className="hamburgercolr hamburger-line-in hamburger-line-in-3"/>
          </div>
          <div className="hamburger-line hamburger-line-cross-1">
            <div className="hamburgercolr hamburger-line-in hamburger-line-in-cross-1"/>
          </div>
          <div className="hamburger-line hamburger-line-cross-2">
            <div className="hamburgercolr hamburger-line-in hamburger-line-in-cross-2"/>
          </div>
        </button>
